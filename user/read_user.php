...
$sql = "SELECT 
    ...
    user.username, 
    user.password, 
    peminjaman_buku.id_peminjaman, 
    peminjaman_buku.id_buku, 
    peminjaman_buku.username AS peminjam_username, 
    peminjaman_buku.nama_buku, 
    peminjaman_buku.jumlah_dipinjam, 
    peminjaman_buku.tanggal_pinjam, 
    peminjaman_buku.tanggal_kembali
FROM 
    user
LEFT JOIN 
    peminjaman_buku ON user.id_user = peminjaman_buku.id_user;";
              ...
              ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="/vitonbook-native/user/delete_user.php?id_user=<?php echo $row['id_user']; ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Hapus</a>
                    </td>
                  </tr>
                <?php
                endwhile;
