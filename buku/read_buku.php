...
$sql = "SELECT buku.id_buku, buku.gambar, buku.nama_buku, buku.publisher, buku.kategori, buku.deskripsi, buku.jumlah_tersedia 
FROM buku 
LEFT JOIN peminjaman_buku 
ON buku.id_buku = peminjaman_buku.id_buku;
";
            ...
            <tbody>
              ...
              ?>
                  <tr>
                    ...
                    <td>
                      <a href="/vitonbook-native/buku/edit_buku.php?id_buku=<?php echo $row['id_buku']; ?>" class="btn btn-warning">Ubah</a>
                      <a href="/vitonbook-native/buku/delete_buku.php?id_buku=<?php echo $row['id_buku']; ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Hapus</a>
                    </td>
                  </tr>
                <?php
                endwhile;
