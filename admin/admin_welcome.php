      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="position-sticky pt-3">
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="/vitonbook-native/admin/dashboard.php">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/vitonbook-native/buku/read_peminjaman.php">
            ...
            <li class="nav-item">
              <a href="/vitonbook-native/admin/admin_login.php" class="btn btn-danger" style="width: 150px;">Login</a>
            </li>
          </ul>
        </div>
      </nav>
